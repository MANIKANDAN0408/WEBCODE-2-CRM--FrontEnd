    ...
    <div className='bg-light sticky-top'>
        <div className=' sticky-top bg-light'>
            <div className='navbar container'>
                <img src='https://repathsolutions.com/wp-content/uploads/2020/09/zoho-crm.png' style={{ width: "49px", borderRadius: "6px" }}></img>
                <div>
    ...
    <div className='content-div-auth'>
        <div className=' content text container'>
            <div className='col-12'>
                <h2 className='pt-3 text' style={{ fontSize: "68px" }}>The real customer centric CRM</h2>
                <h3 className='pt-2 text' style={{ fontSize: "48px" }}>Track leads, close opportunities
                    and get accurate forecasts.</h3>
                <div>
                    <button className='mt-3 content-btn'>Start Now - It's Free</button>
                    <p style={{ fontSize: "21px" }} className='mt-3 text'>Free,forever,with unlimited users.</p>
                </div>
            </div>
        </div>
    ...
    <div className='d-flex justify-content-center'>
        <form className='col-lg-3 container auth 'onSubmit={formik.handleSubmit}>
            <div className='text-center mb-5'>
                <img src='https://repathsolutions.com/wp-content/uploads/2020/09/zoho-crm.png' style={{ width: "48px", borderRadius: "6px" }}></img>
                <h3>MRT</h3>
            </div>
